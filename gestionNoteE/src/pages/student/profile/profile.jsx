...
const Profile = ({ title }) => {
  ...
  useEffect(() => {
    const fetchProfDetails = async () => {
      try {
        const response = await fetch(`http://localhost:3000/etudiant/${userId}`);
        if (!response.ok) {
                ...
                <>
                  ...
                  <div className="formInput">
                    ...
                    <input
                      type="text"
                      name="dateNaissance"
                      value={editedProfDetails.dateNaissance}
                      onChange={handleChange}
                    />
                  </div>
                  <div className="formInput">
                    ...
                    <input
                      type="text"
                      name="motDePasse"
                      value={editedProfDetails.motDePasse}
                      onChange={handleChange}
                    />
                  </div>
                </>
